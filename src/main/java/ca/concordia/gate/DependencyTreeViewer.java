 ...
 *
 *  $Id: SyntaxTreeViewer.java 19751 2016-11-18 09:04:17Z markagreenwood $
 */
...
@CreoleResource(name = "Dependency Tree Viewer 2", comment = "Viewer for dependency trees generated by a parser.", helpURL = "http://gate.ac.uk/userguide/sec:parsers:supple:treeviewer", annotationTypeDisplayed = "Sentence")
public class DependencyTreeViewer extends AbstractVisualResource
  ...
  protected int vertButtonGap = 100;
  ...
  private DependencyTreeViewer(String annotType) {
...
*/
  ...
  private void annotations2Trees() {
    ...
    Collections.sort(nodeAnnots, new OffsetComparator());
  ...
  private static class FocusButton extends JButton {
    ...
    public void processComponentKeyEvent(KeyEvent e) {
      ...
      if (e.getKeyCode() == KeyEvent.VK_DELETE) {
        DependencyTreeViewer viewer = (DependencyTreeViewer) ((JButton) e.getSource()).getParent();
